// pack de plugin unicode xregexp: scripts v1.1

var XRegExp;

if (!(XRegExp && XRegExp.addUnicodePackage)) {
    throw ReferenceError("o plugin unicode do xregexp deve ser carregado antes de adicionar scripts");
}
...
// exclui 31 scripts unicode v6.1 sem pontos de código no bmp